...
golem::fill_desc(
  ...
  repo_url = "https://github.com/ThomUK/DESPatientPathway", # The URL of the GitHub Repo (optional),
...
usethis::use_mit_license("Tom Smith") # You can set another license here
usethis::use_readme_rmd(open = FALSE)
devtools::build_readme()
# Note that `contact` is required since usethis version 2.1.5
# If your {usethis} version is older, you can remove that param
usethis::use_code_of_conduct(contact = "Tom Smith")
